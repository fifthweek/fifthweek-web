...
var QueueNameInputPage = function() {};

QueueNameInputPage.prototype = Object.create({},
  {
    newName: { value: function() {
      return 'Queue ' + Math.round(Math.random() * 100000);
    }},
    ...
    includeHappyPaths: { value: function(applyValue) {
      ...
      it('should allow queue names with 1 characters or more', function(){
        applyValue('1');
      });

      it('should allow queue names with punctuation', function(){
        applyValue(testKit.punctuation33);
      });

      it('should allow queue names with numbers', function(){
        applyValue('1234567890');
      });

      it('should allow queue names with trailing and leading whitespace', function(){
    ...
    includeSadPaths: { value: function(inputId, button, helpMessages, isOptional) {
      ...
      if(!isOptional) {
        it('requires queue name', function () {
      ...
      it('should not allow queue names with over than 50 characters', function(){
        var maxLength = 50;
...
module.exports = QueueNameInputPage;
